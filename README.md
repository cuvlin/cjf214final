...
## /paper
This folder contains the final Quarto Document file that plots our data and created a figure. This Quarto document outputs the final figure to /figs and creates and html file for GitHub pages in /docs
